...
class Products extends CI_Controller {
    ...
    public function item_submit() {
        ...
        if ($this->form_validation->run() == FALSE) {
            // Reload the form with validation errors
            $data['title'] = 'Add New';
            $result['header'] = 'New Product';
            $this->load->view('layouts/header', $data);
            $this->load->view('products/add_item', $result);
        } else {
            // Prepare data to insert into the database
            $data = array(
    ...
    public function variant_submit() {
        ...
        $this->form_validation->set_rules('quatity', 'quatity', 'required');
    ...
    public function displayitems() {
        ...
        $result['data'] = $this->Product_model->get_items();
